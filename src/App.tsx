              ...
              {(validation.errors.length > 0 || validation.warnings.length > 0) && (
                <div className="mt-6 space-y-3">
                  {validation.errors.map((error, index) => (
                    <div key={index} className="flex items-start space-x-3 text-sm text-red-700 bg-red-50 border border-red-200 p-4 rounded-lg">
                  ...
                  {validation.warnings.map((warning, index) => (
                    <div key={index} className="flex items-start space-x-3 text-sm text-amber-700 bg-amber-50 border border-amber-200 p-4 rounded-lg">
