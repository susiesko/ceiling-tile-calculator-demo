        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-200/50">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-blue-900 text-lg">{calculation.fullTiles.toLocaleString()}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-blue-700 font-medium">Partial tiles:</span>
              <span className="font-bold text-blue-900 text-lg">{calculation.partialTiles.toLocaleString()}</span>
            </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-200/50">
          <div className="flex items-center space-x-3 mb-4">
            <div className="w-6 h-6 bg-purple-500 rounded-lg flex items-center justify-center">
              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 8V4a1 1 0 011-1h14a1 1 0 011 1v4M4 8h16M4 8v8a1 1 0 001 1h4m10-9v9a1 1 0 01-1 1H9" />
              </svg>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-purple-900 text-lg">{calculation.area.toFixed(1)} {unitLabel}</span>
            </div>
            <div className="flex justify-between items-center">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-2xl border border-green-200/50">
            ...
            <div className="space-y-3">
              <div className="text-center">
                ...
                <div className="text-green-700 font-medium bg-white px-4 py-2 rounded-lg shadow-sm inline-block">
