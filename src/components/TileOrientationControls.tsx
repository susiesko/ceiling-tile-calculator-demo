...
export function TileOrientationControls({className = ''}: TileOrientationControlsProps) {
        ...
        <div className={`space-y-4 ${className}`}>
            ...
            <div className="grid grid-cols-2 gap-6">
                {([0, 90] as TileOrientation[]).map((orientation) => (
                    <div
                        key={orientation}
                        onClick={() => updateTileConfig({orientation})}
                    ...
                    >
                        <div className="flex flex-col items-center space-y-3">
                            <TileOrientationIcon orientation={orientation}
                                                 isSelected={tileConfig.orientation === orientation}/>
